          ...
          <Grid item xs={12} sx={{ width: "70vw" }}>
            <div onClick={() => navigateHandler("Admin")}>
              <StyledPaper elevation={3}>
                ...
                <StyledTypography>Principle</StyledTypography>
                Login as as Principle to access the dashboard to manage app
                data.
              </StyledPaper>
            </div>
          </Grid>
...
const StyledContainer = styled.div`
  background: linear-gradient(to bottom, #e0b3ff, #b3e0ff);
